...
mixin _$MarketIndicatorPriceResponse {
 ...
 String get lastPrice; SymbolCatalog get symbol;@DateTimeConverter() DateTime? get timestamp;
/// Create a copy of MarketIndicatorPriceResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MarketIndicatorPriceResponseCopyWith<MarketIndicatorPriceResponse> get copyWith => _$MarketIndicatorPriceResponseCopyWithImpl<MarketIndicatorPriceResponse>(this as MarketIndicatorPriceResponse, _$identity);
...
int get hashCode {
  final _this = this as MarketIndicatorPriceResponse;
  return Object.hash(runtimeType,_this.lastPrice,_this.symbol,_this.timestamp);
}

@override
String toString() {
  final _this = this as MarketIndicatorPriceResponse;
  return 'MarketIndicatorPriceResponse(lastPrice: ${_this.lastPrice}, symbol: ${_this.symbol}, timestamp: ${_this.timestamp})';
}
...
abstract mixin class $MarketIndicatorPriceResponseCopyWith<$Res>  {
  factory $MarketIndicatorPriceResponseCopyWith(MarketIndicatorPriceResponse value, $Res Function(MarketIndicatorPriceResponse) _then) = _$MarketIndicatorPriceResponseCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of MarketIndicatorPriceResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lastPrice = null,Object? symbol = null,Object? timestamp = freezed,}) {
...
as SymbolCatalog,timestamp: freezed == timestamp ? _self.timestamp : timestamp // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MarketIndicatorPriceResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _MarketIndicatorPriceResponse implements MarketIndicatorPriceResponse {
  const _MarketIndicatorPriceResponse({required this.lastPrice, required this.symbol, @DateTimeConverter() this.timestamp});
  factory _MarketIndicatorPriceResponse.fromJson(Map<String, dynamic> json) => _$MarketIndicatorPriceResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$MarketIndicatorPriceResponseCopyWith<_MarketIndicatorPriceResponse> get copyWith => __$MarketIndicatorPriceResponseCopyWithImpl<_MarketIndicatorPriceResponse>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _MarketIndicatorPriceResponse&&(identical(other.lastPrice, lastPrice) || other.lastPrice == lastPrice)&&(identical(other.symbol, symbol) || other.symbol == symbol)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp));
}
...
/// @nodoc
abstract mixin class _$MarketIndicatorPriceResponseCopyWith<$Res> implements $MarketIndicatorPriceResponseCopyWith<$Res> {
  factory _$MarketIndicatorPriceResponseCopyWith(_MarketIndicatorPriceResponse value, $Res Function(_MarketIndicatorPriceResponse) _then) = __$MarketIndicatorPriceResponseCopyWithImpl;
@override @useResult
$Res call({
 String lastPrice, SymbolCatalog symbol,@DateTimeConverter() DateTime? timestamp
});
...
/// Create a copy of MarketIndicatorPriceResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lastPrice = null,Object? symbol = null,Object? timestamp = freezed,}) {
...
mixin _$MarketIndicatorCandlePageResponse {
 ...
 List<MarketIndicatorCandle> get candles;@DateTimeConverter() DateTime? get nextBefore;
/// Create a copy of MarketIndicatorCandlePageResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MarketIndicatorCandlePageResponseCopyWith<MarketIndicatorCandlePageResponse> get copyWith => _$MarketIndicatorCandlePageResponseCopyWithImpl<MarketIndicatorCandlePageResponse>(this as MarketIndicatorCandlePageResponse, _$identity);
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarketIndicatorCandlePageResponse&&const DeepCollectionEquality().equals(other.candles, _this.candles)&&(identical(other.nextBefore, _this.nextBefore) || other.nextBefore == _this.nextBefore));
}
...
String toString() {
  final _this = this as MarketIndicatorCandlePageResponse;
  return 'MarketIndicatorCandlePageResponse(candles: ${_this.candles}, nextBefore: ${_this.nextBefore})';
}
...
abstract mixin class $MarketIndicatorCandlePageResponseCopyWith<$Res>  {
  factory $MarketIndicatorCandlePageResponseCopyWith(MarketIndicatorCandlePageResponse value, $Res Function(MarketIndicatorCandlePageResponse) _then) = _$MarketIndicatorCandlePageResponseCopyWithImpl;
@useResult
$Res call({
 List<MarketIndicatorCandle> candles,@DateTimeConverter() DateTime? nextBefore
});
...
as List<MarketIndicatorCandle>,nextBefore: freezed == nextBefore ? _self.nextBefore : nextBefore // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MarketIndicatorCandlePageResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _MarketIndicatorCandlePageResponse implements MarketIndicatorCandlePageResponse {
  const _MarketIndicatorCandlePageResponse({required  List<MarketIndicatorCandle> candles, @DateTimeConverter() this.nextBefore}): _candles = candles;
  factory _MarketIndicatorCandlePageResponse.fromJson(Map<String, dynamic> json) => _$MarketIndicatorCandlePageResponseFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$MarketIndicatorCandlePageResponseCopyWith<_MarketIndicatorCandlePageResponse> get copyWith => __$MarketIndicatorCandlePageResponseCopyWithImpl<_MarketIndicatorCandlePageResponse>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _MarketIndicatorCandlePageResponse&&const DeepCollectionEquality().equals(other.candles, _candles)&&(identical(other.nextBefore, nextBefore) || other.nextBefore == nextBefore));
}
...
/// @nodoc
abstract mixin class _$MarketIndicatorCandlePageResponseCopyWith<$Res> implements $MarketIndicatorCandlePageResponseCopyWith<$Res> {
  factory _$MarketIndicatorCandlePageResponseCopyWith(_MarketIndicatorCandlePageResponse value, $Res Function(_MarketIndicatorCandlePageResponse) _then) = __$MarketIndicatorCandlePageResponseCopyWithImpl;
@override @useResult
$Res call({
 List<MarketIndicatorCandle> candles,@DateTimeConverter() DateTime? nextBefore
});
...
mixin _$MarketIndicatorCandle {
 ...
 String get closePrice; String get highPrice; String get lowPrice; String get openPrice;@DateTimeConverter() DateTime get timestamp; String get volume;
/// Create a copy of MarketIndicatorCandle
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MarketIndicatorCandleCopyWith<MarketIndicatorCandle> get copyWith => _$MarketIndicatorCandleCopyWithImpl<MarketIndicatorCandle>(this as MarketIndicatorCandle, _$identity);
...
int get hashCode {
  final _this = this as MarketIndicatorCandle;
  return Object.hash(runtimeType,_this.closePrice,_this.highPrice,_this.lowPrice,_this.openPrice,_this.timestamp,_this.volume);
}

@override
String toString() {
  final _this = this as MarketIndicatorCandle;
  return 'MarketIndicatorCandle(closePrice: ${_this.closePrice}, highPrice: ${_this.highPrice}, lowPrice: ${_this.lowPrice}, openPrice: ${_this.openPrice}, timestamp: ${_this.timestamp}, volume: ${_this.volume})';
}
...
abstract mixin class $MarketIndicatorCandleCopyWith<$Res>  {
  factory $MarketIndicatorCandleCopyWith(MarketIndicatorCandle value, $Res Function(MarketIndicatorCandle) _then) = _$MarketIndicatorCandleCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of MarketIndicatorCandle
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? closePrice = null,Object? highPrice = null,Object? lowPrice = null,Object? openPrice = null,Object? timestamp = null,Object? volume = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MarketIndicatorCandle value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _MarketIndicatorCandle implements MarketIndicatorCandle {
  const _MarketIndicatorCandle({required this.closePrice, required this.highPrice, required this.lowPrice, required this.openPrice, @DateTimeConverter() required this.timestamp, required this.volume});
  factory _MarketIndicatorCandle.fromJson(Map<String, dynamic> json) => _$MarketIndicatorCandleFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$MarketIndicatorCandleCopyWith<_MarketIndicatorCandle> get copyWith => __$MarketIndicatorCandleCopyWithImpl<_MarketIndicatorCandle>(this, _$identity);
...
/// @nodoc
abstract mixin class _$MarketIndicatorCandleCopyWith<$Res> implements $MarketIndicatorCandleCopyWith<$Res> {
  factory _$MarketIndicatorCandleCopyWith(_MarketIndicatorCandle value, $Res Function(_MarketIndicatorCandle) _then) = __$MarketIndicatorCandleCopyWithImpl;
@override @useResult
$Res call({
 String closePrice, String highPrice, String lowPrice, String openPrice,@DateTimeConverter() DateTime timestamp, String volume
});
...
/// Create a copy of MarketIndicatorCandle
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? closePrice = null,Object? highPrice = null,Object? lowPrice = null,Object? openPrice = null,Object? timestamp = null,Object? volume = null,}) {
...
mixin _$InvestorTradingResponse {
 ...
 List<InvestorTradingRecord> get records;@DateTimeConverter() DateTime? get nextUntil;
/// Create a copy of InvestorTradingResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InvestorTradingResponseCopyWith<InvestorTradingResponse> get copyWith => _$InvestorTradingResponseCopyWithImpl<InvestorTradingResponse>(this as InvestorTradingResponse, _$identity);
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InvestorTradingResponse&&const DeepCollectionEquality().equals(other.records, _this.records)&&(identical(other.nextUntil, _this.nextUntil) || other.nextUntil == _this.nextUntil));
}
...
String toString() {
  final _this = this as InvestorTradingResponse;
  return 'InvestorTradingResponse(records: ${_this.records}, nextUntil: ${_this.nextUntil})';
}
...
abstract mixin class $InvestorTradingResponseCopyWith<$Res>  {
  factory $InvestorTradingResponseCopyWith(InvestorTradingResponse value, $Res Function(InvestorTradingResponse) _then) = _$InvestorTradingResponseCopyWithImpl;
@useResult
$Res call({
 List<InvestorTradingRecord> records,@DateTimeConverter() DateTime? nextUntil
});
...
as List<InvestorTradingRecord>,nextUntil: freezed == nextUntil ? _self.nextUntil : nextUntil // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InvestorTradingResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _InvestorTradingResponse implements InvestorTradingResponse {
  const _InvestorTradingResponse({required  List<InvestorTradingRecord> records, @DateTimeConverter() this.nextUntil}): _records = records;
  factory _InvestorTradingResponse.fromJson(Map<String, dynamic> json) => _$InvestorTradingResponseFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$InvestorTradingResponseCopyWith<_InvestorTradingResponse> get copyWith => __$InvestorTradingResponseCopyWithImpl<_InvestorTradingResponse>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _InvestorTradingResponse&&const DeepCollectionEquality().equals(other.records, _records)&&(identical(other.nextUntil, nextUntil) || other.nextUntil == nextUntil));
}
...
/// @nodoc
abstract mixin class _$InvestorTradingResponseCopyWith<$Res> implements $InvestorTradingResponseCopyWith<$Res> {
  factory _$InvestorTradingResponseCopyWith(_InvestorTradingResponse value, $Res Function(_InvestorTradingResponse) _then) = __$InvestorTradingResponseCopyWithImpl;
@override @useResult
$Res call({
 List<InvestorTradingRecord> records,@DateTimeConverter() DateTime? nextUntil
});
...
@DateTimeConverter() DateTime get date; InvestorTradingAmount get foreigner; InvestorTradingAmount get individual; InstitutionTradingAmount get institution; InvestorTradingAmount get otherCorporation;@DateTimeConverter() DateTime get updatedAt;
/// Create a copy of InvestorTradingRecord
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InvestorTradingRecordCopyWith<InvestorTradingRecord> get copyWith => _$InvestorTradingRecordCopyWithImpl<InvestorTradingRecord>(this as InvestorTradingRecord, _$identity);
...
int get hashCode {
  final _this = this as InvestorTradingRecord;
  return Object.hash(runtimeType,_this.date,_this.foreigner,_this.individual,_this.institution,_this.otherCorporation,_this.updatedAt);
}

@override
String toString() {
  final _this = this as InvestorTradingRecord;
  return 'InvestorTradingRecord(date: ${_this.date}, foreigner: ${_this.foreigner}, individual: ${_this.individual}, institution: ${_this.institution}, otherCorporation: ${_this.otherCorporation}, updatedAt: ${_this.updatedAt})';
}
...
abstract mixin class $InvestorTradingRecordCopyWith<$Res>  {
  factory $InvestorTradingRecordCopyWith(InvestorTradingRecord value, $Res Function(InvestorTradingRecord) _then) = _$InvestorTradingRecordCopyWithImpl;
@useResult
$Res call({
...
$InvestorTradingAmountCopyWith<$Res> get foreigner;$InvestorTradingAmountCopyWith<$Res> get individual;$InstitutionTradingAmountCopyWith<$Res> get institution;$InvestorTradingAmountCopyWith<$Res> get otherCorporation;
...
/// Create a copy of InvestorTradingRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? date = null,Object? foreigner = null,Object? individual = null,Object? institution = null,Object? otherCorporation = null,Object? updatedAt = null,}) {
...
as InvestorTradingAmount,individual: null == individual ? _self.individual : individual // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,institution: null == institution ? _self.institution : institution // ignore: cast_nullable_to_non_nullable
as InstitutionTradingAmount,otherCorporation: null == otherCorporation ? _self.otherCorporation : otherCorporation // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
/// Create a copy of InvestorTradingRecord
...
$InvestorTradingAmountCopyWith<$Res> get otherCorporation {
  ...
  return $InvestorTradingAmountCopyWith<$Res>(_self.otherCorporation, (value) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InvestorTradingRecord value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _InvestorTradingRecord implements InvestorTradingRecord {
  const _InvestorTradingRecord({@DateTimeConverter() required this.date, required this.foreigner, required this.individual, required this.institution, required this.otherCorporation, @DateTimeConverter() required this.updatedAt});
  factory _InvestorTradingRecord.fromJson(Map<String, dynamic> json) => _$InvestorTradingRecordFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$InvestorTradingRecordCopyWith<_InvestorTradingRecord> get copyWith => __$InvestorTradingRecordCopyWithImpl<_InvestorTradingRecord>(this, _$identity);
...
/// @nodoc
abstract mixin class _$InvestorTradingRecordCopyWith<$Res> implements $InvestorTradingRecordCopyWith<$Res> {
  factory _$InvestorTradingRecordCopyWith(_InvestorTradingRecord value, $Res Function(_InvestorTradingRecord) _then) = __$InvestorTradingRecordCopyWithImpl;
@override @useResult
$Res call({
@DateTimeConverter() DateTime date, InvestorTradingAmount foreigner, InvestorTradingAmount individual, InstitutionTradingAmount institution, InvestorTradingAmount otherCorporation,@DateTimeConverter() DateTime updatedAt
});
...
@override $InvestorTradingAmountCopyWith<$Res> get foreigner;@override $InvestorTradingAmountCopyWith<$Res> get individual;@override $InstitutionTradingAmountCopyWith<$Res> get institution;@override $InvestorTradingAmountCopyWith<$Res> get otherCorporation;
...
/// Create a copy of InvestorTradingRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? date = null,Object? foreigner = null,Object? individual = null,Object? institution = null,Object? otherCorporation = null,Object? updatedAt = null,}) {
...
mixin _$InvestorTradingAmount {
 ...
 String get buyAmount; String get sellAmount;
/// Create a copy of InvestorTradingAmount
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InvestorTradingAmountCopyWith<InvestorTradingAmount> get copyWith => _$InvestorTradingAmountCopyWithImpl<InvestorTradingAmount>(this as InvestorTradingAmount, _$identity);
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InvestorTradingAmount&&(identical(other.buyAmount, _this.buyAmount) || other.buyAmount == _this.buyAmount)&&(identical(other.sellAmount, _this.sellAmount) || other.sellAmount == _this.sellAmount));
}
...
String toString() {
  final _this = this as InvestorTradingAmount;
  return 'InvestorTradingAmount(buyAmount: ${_this.buyAmount}, sellAmount: ${_this.sellAmount})';
}
...
abstract mixin class $InvestorTradingAmountCopyWith<$Res>  {
  factory $InvestorTradingAmountCopyWith(InvestorTradingAmount value, $Res Function(InvestorTradingAmount) _then) = _$InvestorTradingAmountCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of InvestorTradingAmount
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? buyAmount = null,Object? sellAmount = null,}) {
  return _then(InvestorTradingAmount(
buyAmount: null == buyAmount ? _self.buyAmount : buyAmount // ignore: cast_nullable_to_non_nullable
as String,sellAmount: null == sellAmount ? _self.sellAmount : sellAmount // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InvestorTradingAmount value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _InvestorTradingAmount implements InvestorTradingAmount {
  const _InvestorTradingAmount({required this.buyAmount, required this.sellAmount});
  factory _InvestorTradingAmount.fromJson(Map<String, dynamic> json) => _$InvestorTradingAmountFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$InvestorTradingAmountCopyWith<_InvestorTradingAmount> get copyWith => __$InvestorTradingAmountCopyWithImpl<_InvestorTradingAmount>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _InvestorTradingAmount&&(identical(other.buyAmount, buyAmount) || other.buyAmount == buyAmount)&&(identical(other.sellAmount, sellAmount) || other.sellAmount == sellAmount));
}
...
/// @nodoc
abstract mixin class _$InvestorTradingAmountCopyWith<$Res> implements $InvestorTradingAmountCopyWith<$Res> {
  factory _$InvestorTradingAmountCopyWith(_InvestorTradingAmount value, $Res Function(_InvestorTradingAmount) _then) = __$InvestorTradingAmountCopyWithImpl;
@override @useResult
$Res call({
 String buyAmount, String sellAmount
});
...
/// Create a copy of InvestorTradingAmount
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? buyAmount = null,Object? sellAmount = null,}) {
...
mixin _$InstitutionTradingAmount {
 ...
 InstitutionTradingBreakdown get breakdown; String get buyAmount; String get sellAmount;
/// Create a copy of InstitutionTradingAmount
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InstitutionTradingAmountCopyWith<InstitutionTradingAmount> get copyWith => _$InstitutionTradingAmountCopyWithImpl<InstitutionTradingAmount>(this as InstitutionTradingAmount, _$identity);
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InstitutionTradingAmount&&(identical(other.breakdown, _this.breakdown) || other.breakdown == _this.breakdown)&&(identical(other.buyAmount, _this.buyAmount) || other.buyAmount == _this.buyAmount)&&(identical(other.sellAmount, _this.sellAmount) || other.sellAmount == _this.sellAmount));
}
...
int get hashCode {
  final _this = this as InstitutionTradingAmount;
  return Object.hash(runtimeType,_this.breakdown,_this.buyAmount,_this.sellAmount);
}

@override
String toString() {
  final _this = this as InstitutionTradingAmount;
  return 'InstitutionTradingAmount(breakdown: ${_this.breakdown}, buyAmount: ${_this.buyAmount}, sellAmount: ${_this.sellAmount})';
}
...
abstract mixin class $InstitutionTradingAmountCopyWith<$Res>  {
  factory $InstitutionTradingAmountCopyWith(InstitutionTradingAmount value, $Res Function(InstitutionTradingAmount) _then) = _$InstitutionTradingAmountCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of InstitutionTradingAmount
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? breakdown = null,Object? buyAmount = null,Object? sellAmount = null,}) {
...
as InstitutionTradingBreakdown,buyAmount: null == buyAmount ? _self.buyAmount : buyAmount // ignore: cast_nullable_to_non_nullable
as String,sellAmount: null == sellAmount ? _self.sellAmount : sellAmount // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InstitutionTradingAmount value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _InstitutionTradingAmount implements InstitutionTradingAmount {
  const _InstitutionTradingAmount({required this.breakdown, required this.buyAmount, required this.sellAmount});
  factory _InstitutionTradingAmount.fromJson(Map<String, dynamic> json) => _$InstitutionTradingAmountFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$InstitutionTradingAmountCopyWith<_InstitutionTradingAmount> get copyWith => __$InstitutionTradingAmountCopyWithImpl<_InstitutionTradingAmount>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _InstitutionTradingAmount&&(identical(other.breakdown, breakdown) || other.breakdown == breakdown)&&(identical(other.buyAmount, buyAmount) || other.buyAmount == buyAmount)&&(identical(other.sellAmount, sellAmount) || other.sellAmount == sellAmount));
}
...
/// @nodoc
abstract mixin class _$InstitutionTradingAmountCopyWith<$Res> implements $InstitutionTradingAmountCopyWith<$Res> {
  factory _$InstitutionTradingAmountCopyWith(_InstitutionTradingAmount value, $Res Function(_InstitutionTradingAmount) _then) = __$InstitutionTradingAmountCopyWithImpl;
@override @useResult
$Res call({
 InstitutionTradingBreakdown breakdown, String buyAmount, String sellAmount
});
...
/// Create a copy of InstitutionTradingAmount
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? breakdown = null,Object? buyAmount = null,Object? sellAmount = null,}) {
...
mixin _$InstitutionTradingBreakdown {
 ...
 InvestorTradingAmount get bank; InvestorTradingAmount get financialInvestment; InvestorTradingAmount get insurance; InvestorTradingAmount get otherFinancialInstitution; InvestorTradingAmount get pensionFund; InvestorTradingAmount get privateEquityFund; InvestorTradingAmount get trust;
/// Create a copy of InstitutionTradingBreakdown
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InstitutionTradingBreakdownCopyWith<InstitutionTradingBreakdown> get copyWith => _$InstitutionTradingBreakdownCopyWithImpl<InstitutionTradingBreakdown>(this as InstitutionTradingBreakdown, _$identity);
...
String toString() {
  final _this = this as InstitutionTradingBreakdown;
  return 'InstitutionTradingBreakdown(bank: ${_this.bank}, financialInvestment: ${_this.financialInvestment}, insurance: ${_this.insurance}, otherFinancialInstitution: ${_this.otherFinancialInstitution}, pensionFund: ${_this.pensionFund}, privateEquityFund: ${_this.privateEquityFund}, trust: ${_this.trust})';
}
...
abstract mixin class $InstitutionTradingBreakdownCopyWith<$Res>  {
  factory $InstitutionTradingBreakdownCopyWith(InstitutionTradingBreakdown value, $Res Function(InstitutionTradingBreakdown) _then) = _$InstitutionTradingBreakdownCopyWithImpl;
@useResult
$Res call({
...
$InvestorTradingAmountCopyWith<$Res> get bank;$InvestorTradingAmountCopyWith<$Res> get financialInvestment;$InvestorTradingAmountCopyWith<$Res> get insurance;$InvestorTradingAmountCopyWith<$Res> get otherFinancialInstitution;$InvestorTradingAmountCopyWith<$Res> get pensionFund;$InvestorTradingAmountCopyWith<$Res> get privateEquityFund;$InvestorTradingAmountCopyWith<$Res> get trust;
...
as InvestorTradingAmount,financialInvestment: null == financialInvestment ? _self.financialInvestment : financialInvestment // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,insurance: null == insurance ? _self.insurance : insurance // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,otherFinancialInstitution: null == otherFinancialInstitution ? _self.otherFinancialInstitution : otherFinancialInstitution // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,pensionFund: null == pensionFund ? _self.pensionFund : pensionFund // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,privateEquityFund: null == privateEquityFund ? _self.privateEquityFund : privateEquityFund // ignore: cast_nullable_to_non_nullable
as InvestorTradingAmount,trust: null == trust ? _self.trust : trust // ignore: cast_nullable_to_non_nullable
...
$InvestorTradingAmountCopyWith<$Res> get financialInvestment {
  ...
  return $InvestorTradingAmountCopyWith<$Res>(_self.financialInvestment, (value) {
...
$InvestorTradingAmountCopyWith<$Res> get otherFinancialInstitution {
  ...
  return $InvestorTradingAmountCopyWith<$Res>(_self.otherFinancialInstitution, (value) {
...
$InvestorTradingAmountCopyWith<$Res> get privateEquityFund {
  ...
  return $InvestorTradingAmountCopyWith<$Res>(_self.privateEquityFund, (value) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InstitutionTradingBreakdown value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _InstitutionTradingBreakdown implements InstitutionTradingBreakdown {
  const _InstitutionTradingBreakdown({required this.bank, required this.financialInvestment, required this.insurance, required this.otherFinancialInstitution, required this.pensionFund, required this.privateEquityFund, required this.trust});
  factory _InstitutionTradingBreakdown.fromJson(Map<String, dynamic> json) => _$InstitutionTradingBreakdownFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$InstitutionTradingBreakdownCopyWith<_InstitutionTradingBreakdown> get copyWith => __$InstitutionTradingBreakdownCopyWithImpl<_InstitutionTradingBreakdown>(this, _$identity);
...
/// @nodoc
abstract mixin class _$InstitutionTradingBreakdownCopyWith<$Res> implements $InstitutionTradingBreakdownCopyWith<$Res> {
  factory _$InstitutionTradingBreakdownCopyWith(_InstitutionTradingBreakdown value, $Res Function(_InstitutionTradingBreakdown) _then) = __$InstitutionTradingBreakdownCopyWithImpl;
@override @useResult
$Res call({
 InvestorTradingAmount bank, InvestorTradingAmount financialInvestment, InvestorTradingAmount insurance, InvestorTradingAmount otherFinancialInstitution, InvestorTradingAmount pensionFund, InvestorTradingAmount privateEquityFund, InvestorTradingAmount trust
});
...
@override $InvestorTradingAmountCopyWith<$Res> get bank;@override $InvestorTradingAmountCopyWith<$Res> get financialInvestment;@override $InvestorTradingAmountCopyWith<$Res> get insurance;@override $InvestorTradingAmountCopyWith<$Res> get otherFinancialInstitution;@override $InvestorTradingAmountCopyWith<$Res> get pensionFund;@override $InvestorTradingAmountCopyWith<$Res> get privateEquityFund;@override $InvestorTradingAmountCopyWith<$Res> get trust;
