...
mixin _$ExchangeRateResponse {
  ...
  String get basisPoint;

  String get midRate;

  Currency get quoteCurrency;

  String get rate;

  RateChangeType get rateChangeType;

  @DateTimeConverter() DateTime get validFrom;

  @DateTimeConverter() DateTime get validUntil;
  ...
  $ExchangeRateResponseCopyWith<ExchangeRateResponse> get copyWith =>
      _$ExchangeRateResponseCopyWithImpl<ExchangeRateResponse>(
          this as ExchangeRateResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ExchangeRateResponse &&
            (identical(other.baseCurrency, _this.baseCurrency) ||
                other.baseCurrency == _this.baseCurrency) &&
            (identical(other.basisPoint, _this.basisPoint) ||
                other.basisPoint == _this.basisPoint) &&
            (identical(other.midRate, _this.midRate) ||
                other.midRate == _this.midRate) &&
            (identical(other.quoteCurrency, _this.quoteCurrency) ||
                other.quoteCurrency == _this.quoteCurrency) &&
            (identical(other.rate, _this.rate) || other.rate == _this.rate) &&
            (identical(other.rateChangeType, _this.rateChangeType) ||
                other.rateChangeType == _this.rateChangeType) &&
            (identical(other.validFrom, _this.validFrom) ||
                other.validFrom == _this.validFrom) &&
            (identical(other.validUntil, _this.validUntil) ||
                other.validUntil == _this.validUntil));
  }
  ...
  String toString() {
    final _this = this as ExchangeRateResponse;
    return 'ExchangeRateResponse(baseCurrency: ${_this
        .baseCurrency}, basisPoint: ${_this.basisPoint}, midRate: ${_this
        .midRate}, quoteCurrency: ${_this.quoteCurrency}, rate: ${_this
        .rate}, rateChangeType: ${_this.rateChangeType}, validFrom: ${_this
        .validFrom}, validUntil: ${_this.validUntil})';
  }
...
abstract mixin class $ExchangeRateResponseCopyWith<$Res> {
  factory $ExchangeRateResponseCopyWith(ExchangeRateResponse value,
      $Res Function(ExchangeRateResponse) _then) = _$ExchangeRateResponseCopyWithImpl;
...
class _$ExchangeRateResponseCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? baseCurrency = null, Object? basisPoint = null, Object? midRate = null, Object? quoteCurrency = null, Object? rate = null, Object? rateChangeType = null, Object? validFrom = null, Object? validUntil = null,}) {
    return _then(ExchangeRateResponse(
      baseCurrency: null == baseCurrency
          ? _self.baseCurrency
          : baseCurrency // ignore: cast_nullable_to_non_nullable
      as Currency,
      basisPoint: null == basisPoint
          ? _self.basisPoint
          : basisPoint // ignore: cast_nullable_to_non_nullable
      as String,
      midRate: null == midRate
          ? _self.midRate
      ...
      as String,
      rateChangeType: null == rateChangeType
          ? _self.rateChangeType
          : rateChangeType // ignore: cast_nullable_to_non_nullable
      as RateChangeType,
...
extension ExchangeRateResponsePatterns on ExchangeRateResponse {
  ...
  TResult Function( _ExchangeRateResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _ExchangeRateResponse implements ExchangeRateResponse {
  const _ExchangeRateResponse(
      {required this.baseCurrency, required this.basisPoint, required this.midRate, required this.quoteCurrency, required this.rate, required this.rateChangeType, @DateTimeConverter() required this.validFrom, @DateTimeConverter() required this.validUntil});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ExchangeRateResponseCopyWith<_ExchangeRateResponse> get copyWith =>
      __$ExchangeRateResponseCopyWithImpl<_ExchangeRateResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ExchangeRateResponse &&
            (identical(other.baseCurrency, baseCurrency) ||
                other.baseCurrency == baseCurrency) &&
            (identical(other.basisPoint, basisPoint) ||
                other.basisPoint == basisPoint) &&
            ...
            (identical(other.rateChangeType, rateChangeType) ||
                other.rateChangeType == rateChangeType) &&
...
/// @nodoc
abstract mixin class _$ExchangeRateResponseCopyWith<$Res>
    implements $ExchangeRateResponseCopyWith<$Res> {
  factory _$ExchangeRateResponseCopyWith(_ExchangeRateResponse value,
      $Res Function(_ExchangeRateResponse) _then) = __$ExchangeRateResponseCopyWithImpl;
...
mixin _$KrMarketCalendarResponse {
  ...
  KrMarketDay get nextBusinessDay;

  KrMarketDay get previousBusinessDay;

  KrMarketDay get today;

  /// Create a copy of KrMarketCalendarResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $KrMarketCalendarResponseCopyWith<KrMarketCalendarResponse> get copyWith =>
      _$KrMarketCalendarResponseCopyWithImpl<KrMarketCalendarResponse>(
          this as KrMarketCalendarResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is KrMarketCalendarResponse &&
        (identical(other.nextBusinessDay, _this.nextBusinessDay) ||
            other.nextBusinessDay == _this.nextBusinessDay) &&
        (identical(other.previousBusinessDay, _this.previousBusinessDay) ||
            other.previousBusinessDay == _this.previousBusinessDay) &&
        (identical(other.today, _this.today) || other.today == _this.today));
  }
  ...
  int get hashCode {
    final _this = this as KrMarketCalendarResponse;
    return Object.hash(
        runtimeType, _this.nextBusinessDay, _this.previousBusinessDay,
        _this.today);
  }
  ...
  String toString() {
    final _this = this as KrMarketCalendarResponse;
    return 'KrMarketCalendarResponse(nextBusinessDay: ${_this
        .nextBusinessDay}, previousBusinessDay: ${_this
        .previousBusinessDay}, today: ${_this.today})';
  }
...
abstract mixin class $KrMarketCalendarResponseCopyWith<$Res> {
  factory $KrMarketCalendarResponseCopyWith(KrMarketCalendarResponse value,
      $Res Function(KrMarketCalendarResponse) _then) = _$KrMarketCalendarResponseCopyWithImpl;
...
class _$KrMarketCalendarResponseCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? nextBusinessDay = null, Object? previousBusinessDay = null, Object? today = null,}) {
    return _then(KrMarketCalendarResponse(
      nextBusinessDay: null == nextBusinessDay
          ? _self.nextBusinessDay
          : nextBusinessDay // ignore: cast_nullable_to_non_nullable
      as KrMarketDay,
      previousBusinessDay: null == previousBusinessDay
          ? _self.previousBusinessDay
          : previousBusinessDay // ignore: cast_nullable_to_non_nullable
      as KrMarketDay,
      today: null == today
          ? _self.today
...
extension KrMarketCalendarResponsePatterns on KrMarketCalendarResponse {
  ...
  TResult Function( _KrMarketCalendarResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _KrMarketCalendarResponse implements KrMarketCalendarResponse {
  const _KrMarketCalendarResponse(
      {required this.nextBusinessDay, required this.previousBusinessDay, required this.today});

  factory _KrMarketCalendarResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$KrMarketCalendarResponseCopyWith<_KrMarketCalendarResponse> get copyWith =>
      __$KrMarketCalendarResponseCopyWithImpl<_KrMarketCalendarResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is _KrMarketCalendarResponse &&
        (identical(other.nextBusinessDay, nextBusinessDay) ||
            other.nextBusinessDay == nextBusinessDay) &&
        (identical(other.previousBusinessDay, previousBusinessDay) ||
            other.previousBusinessDay == previousBusinessDay) &&
  ...
  int get hashCode {
    return Object.hash(
        runtimeType, nextBusinessDay, previousBusinessDay, today);
  }
...
/// @nodoc
abstract mixin class _$KrMarketCalendarResponseCopyWith<$Res>
    implements $KrMarketCalendarResponseCopyWith<$Res> {
  factory _$KrMarketCalendarResponseCopyWith(_KrMarketCalendarResponse value,
      $Res Function(_KrMarketCalendarResponse) _then) = __$KrMarketCalendarResponseCopyWithImpl;
  ...
  @override $KrMarketDayCopyWith<$Res> get nextBusinessDay;

  @override $KrMarketDayCopyWith<$Res> get previousBusinessDay;

  @override $KrMarketDayCopyWith<$Res> get today;
...
mixin _$KrMarketDay {
  ...
  IntegratedHour? get integrated;

  /// Create a copy of KrMarketDay
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $KrMarketDayCopyWith<KrMarketDay> get copyWith =>
      _$KrMarketDayCopyWithImpl<KrMarketDay>(this as KrMarketDay, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is KrMarketDay &&
            (identical(other.date, _this.date) || other.date == _this.date) &&
            (identical(other.integrated, _this.integrated) ||
                other.integrated == _this.integrated));
  }
...
abstract mixin class $KrMarketDayCopyWith<$Res> {
  factory $KrMarketDayCopyWith(KrMarketDay value,
      $Res Function(KrMarketDay) _then) = _$KrMarketDayCopyWithImpl;
...
class _$KrMarketDayCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? date = null, Object? integrated = freezed,}) {
...
extension KrMarketDayPatterns on KrMarketDay {
  ...
  TResult Function( _KrMarketDay value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _KrMarketDay implements KrMarketDay {
  const _KrMarketDay(
      {@DateTimeConverter() required this.date, this.integrated});

  factory _KrMarketDay.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$KrMarketDayCopyWith<_KrMarketDay> get copyWith =>
      __$KrMarketDayCopyWithImpl<_KrMarketDay>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _KrMarketDay &&
            (identical(other.date, date) || other.date == date) &&
            (identical(other.integrated, integrated) ||
...
/// @nodoc
abstract mixin class _$KrMarketDayCopyWith<$Res>
    implements $KrMarketDayCopyWith<$Res> {
  factory _$KrMarketDayCopyWith(_KrMarketDay value,
      $Res Function(_KrMarketDay) _then) = __$KrMarketDayCopyWithImpl;
...
mixin _$IntegratedHour {
  ...
  AfterMarketSession? get afterMarket;

  PreMarketSession? get preMarket;

  RegularMarketSession? get regularMarket;

  /// Create a copy of IntegratedHour
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $IntegratedHourCopyWith<IntegratedHour> get copyWith =>
      _$IntegratedHourCopyWithImpl<IntegratedHour>(
          this as IntegratedHour, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is IntegratedHour &&
            (identical(other.afterMarket, _this.afterMarket) ||
                other.afterMarket == _this.afterMarket) &&
            (identical(other.preMarket, _this.preMarket) ||
                other.preMarket == _this.preMarket) &&
            (identical(other.regularMarket, _this.regularMarket) ||
                other.regularMarket == _this.regularMarket));
  }
  ...
  int get hashCode {
    final _this = this as IntegratedHour;
    return Object.hash(
        runtimeType, _this.afterMarket, _this.preMarket, _this.regularMarket);
  }

  @override
  String toString() {
    final _this = this as IntegratedHour;
    return 'IntegratedHour(afterMarket: ${_this.afterMarket}, preMarket: ${_this
        .preMarket}, regularMarket: ${_this.regularMarket})';
  }
...
abstract mixin class $IntegratedHourCopyWith<$Res> {
  factory $IntegratedHourCopyWith(IntegratedHour value,
      $Res Function(IntegratedHour) _then) = _$IntegratedHourCopyWithImpl;
...
class _$IntegratedHourCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? afterMarket = freezed, Object? preMarket = freezed, Object? regularMarket = freezed,}) {
    return _then(IntegratedHour(
      afterMarket: freezed == afterMarket
          ? _self.afterMarket
          : afterMarket // ignore: cast_nullable_to_non_nullable
      as AfterMarketSession?,
      preMarket: freezed == preMarket
          ? _self.preMarket
          : preMarket // ignore: cast_nullable_to_non_nullable
      as PreMarketSession?,
      regularMarket: freezed == regularMarket
          ? _self.regularMarket
          : regularMarket // ignore: cast_nullable_to_non_nullable
...
extension IntegratedHourPatterns on IntegratedHour {
  ...
  TResult Function( _IntegratedHour value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _IntegratedHour implements IntegratedHour {
  ...
  factory _IntegratedHour.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IntegratedHourCopyWith<_IntegratedHour> get copyWith =>
      __$IntegratedHourCopyWithImpl<_IntegratedHour>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _IntegratedHour &&
            (identical(other.afterMarket, afterMarket) ||
                other.afterMarket == afterMarket) &&
            (identical(other.preMarket, preMarket) ||
                other.preMarket == preMarket) &&
            (identical(other.regularMarket, regularMarket) ||
                other.regularMarket == regularMarket));
  }
...
/// @nodoc
abstract mixin class _$IntegratedHourCopyWith<$Res>
    implements $IntegratedHourCopyWith<$Res> {
  factory _$IntegratedHourCopyWith(_IntegratedHour value,
      $Res Function(_IntegratedHour) _then) = __$IntegratedHourCopyWithImpl;
  ...
  @override $AfterMarketSessionCopyWith<$Res>? get afterMarket;

  @override $PreMarketSessionCopyWith<$Res>? get preMarket;

  @override $RegularMarketSessionCopyWith<$Res>? get regularMarket;
...
mixin _$AfterMarketSession {
  ...
  @DateTimeConverter() DateTime get endTime;

  @DateTimeConverter() DateTime get startTime;

  @DateTimeConverter() DateTime? get singlePriceAuctionEndTime;

  /// Create a copy of AfterMarketSession
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AfterMarketSessionCopyWith<AfterMarketSession> get copyWith =>
      _$AfterMarketSessionCopyWithImpl<AfterMarketSession>(
          this as AfterMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is AfterMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime) && (identical(
            other.singlePriceAuctionEndTime, _this.singlePriceAuctionEndTime) ||
            other.singlePriceAuctionEndTime ==
  ...
  String toString() {
    final _this = this as AfterMarketSession;
    return 'AfterMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime}, singlePriceAuctionEndTime: ${_this
...
abstract mixin class $AfterMarketSessionCopyWith<$Res> {
  factory $AfterMarketSessionCopyWith(AfterMarketSession value,
      $Res Function(AfterMarketSession) _then) = _$AfterMarketSessionCopyWithImpl;
...
class _$AfterMarketSessionCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? endTime = null, Object? startTime = null, Object? singlePriceAuctionEndTime = freezed,}) {
    return _then(AfterMarketSession(
      ...
      as DateTime,
      singlePriceAuctionEndTime: freezed == singlePriceAuctionEndTime
          ? _self.singlePriceAuctionEndTime
          : singlePriceAuctionEndTime // ignore: cast_nullable_to_non_nullable
      as DateTime?,
    ));
  }
...
extension AfterMarketSessionPatterns on AfterMarketSession {
  ...
  TResult Function( _AfterMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _AfterMarketSession implements AfterMarketSession {
  const _AfterMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime, @DateTimeConverter() this.singlePriceAuctionEndTime});

  factory _AfterMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @DateTimeConverter()
  final DateTime? singlePriceAuctionEndTime;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AfterMarketSessionCopyWith<_AfterMarketSession> get copyWith =>
      __$AfterMarketSessionCopyWithImpl<_AfterMarketSession>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _AfterMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
                other.startTime == startTime) && (identical(
            other.singlePriceAuctionEndTime, singlePriceAuctionEndTime) ||
            other.singlePriceAuctionEndTime == singlePriceAuctionEndTime));
  }
  ...
  int get hashCode {
    return Object.hash(
        runtimeType, endTime, startTime, singlePriceAuctionEndTime);
  }
...
/// @nodoc
abstract mixin class _$AfterMarketSessionCopyWith<$Res>
    implements $AfterMarketSessionCopyWith<$Res> {
  factory _$AfterMarketSessionCopyWith(_AfterMarketSession value,
      $Res Function(_AfterMarketSession) _then) = __$AfterMarketSessionCopyWithImpl;
...
mixin _$PreMarketSession {
  ...
  @DateTimeConverter() DateTime? get singlePriceAuctionStartTime;

  /// Create a copy of PreMarketSession
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PreMarketSessionCopyWith<PreMarketSession> get copyWith =>
      _$PreMarketSessionCopyWithImpl<PreMarketSession>(
          this as PreMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PreMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime) && (identical(
            other.singlePriceAuctionStartTime,
            _this.singlePriceAuctionStartTime) ||
            other.singlePriceAuctionStartTime ==
                _this.singlePriceAuctionStartTime));
  }
  ...
  String toString() {
    final _this = this as PreMarketSession;
    return 'PreMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime}, singlePriceAuctionStartTime: ${_this
...
abstract mixin class $PreMarketSessionCopyWith<$Res> {
  factory $PreMarketSessionCopyWith(PreMarketSession value,
      $Res Function(PreMarketSession) _then) = _$PreMarketSessionCopyWithImpl;
...
class _$PreMarketSessionCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? endTime = null, Object? startTime = null, Object? singlePriceAuctionStartTime = freezed,}) {
    return _then(PreMarketSession(
      ...
      startTime: null == startTime
          ...
          : startTime // ignore: cast_nullable_to_non_nullable
      as DateTime,
      singlePriceAuctionStartTime: freezed == singlePriceAuctionStartTime
          ? _self.singlePriceAuctionStartTime
          : singlePriceAuctionStartTime // ignore: cast_nullable_to_non_nullable
      as DateTime?,
    ));
  }
...
extension PreMarketSessionPatterns on PreMarketSession {
  ...
  TResult Function( _PreMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _PreMarketSession implements PreMarketSession {
  const _PreMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime, @DateTimeConverter() this.singlePriceAuctionStartTime});

  factory _PreMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @DateTimeConverter()
  final DateTime? singlePriceAuctionStartTime;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PreMarketSessionCopyWith<_PreMarketSession> get copyWith =>
      __$PreMarketSessionCopyWithImpl<_PreMarketSession>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _PreMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
                other.startTime == startTime) && (identical(
            other.singlePriceAuctionStartTime, singlePriceAuctionStartTime) ||
            other.singlePriceAuctionStartTime == singlePriceAuctionStartTime));
  }
  ...
  int get hashCode {
    return Object.hash(
        runtimeType, endTime, startTime, singlePriceAuctionStartTime);
  }
...
/// @nodoc
abstract mixin class _$PreMarketSessionCopyWith<$Res>
    implements $PreMarketSessionCopyWith<$Res> {
  factory _$PreMarketSessionCopyWith(_PreMarketSession value,
      $Res Function(_PreMarketSession) _then) = __$PreMarketSessionCopyWithImpl;
...
mixin _$RegularMarketSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RegularMarketSessionCopyWith<RegularMarketSession> get copyWith =>
      _$RegularMarketSessionCopyWithImpl<RegularMarketSession>(
          this as RegularMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RegularMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime) && (identical(
  ...
  String toString() {
    final _this = this as RegularMarketSession;
    return 'RegularMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime}, singlePriceAuctionStartTime: ${_this
        .singlePriceAuctionStartTime})';
  }
...
abstract mixin class $RegularMarketSessionCopyWith<$Res> {
  factory $RegularMarketSessionCopyWith(RegularMarketSession value,
      $Res Function(RegularMarketSession) _then) = _$RegularMarketSessionCopyWithImpl;
...
extension RegularMarketSessionPatterns on RegularMarketSession {
  ...
  TResult Function( _RegularMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _RegularMarketSession implements RegularMarketSession {
  const _RegularMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime, @DateTimeConverter() this.singlePriceAuctionStartTime});

  factory _RegularMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RegularMarketSessionCopyWith<_RegularMarketSession> get copyWith =>
      __$RegularMarketSessionCopyWithImpl<_RegularMarketSession>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _RegularMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
                other.startTime == startTime) && (identical(
            other.singlePriceAuctionStartTime, singlePriceAuctionStartTime) ||
...
/// @nodoc
abstract mixin class _$RegularMarketSessionCopyWith<$Res>
    implements $RegularMarketSessionCopyWith<$Res> {
  factory _$RegularMarketSessionCopyWith(_RegularMarketSession value,
      $Res Function(_RegularMarketSession) _then) = __$RegularMarketSessionCopyWithImpl;
...
mixin _$UsMarketCalendarResponse {
  ...
  UsMarketDay get nextBusinessDay;

  UsMarketDay get previousBusinessDay;

  UsMarketDay get today;

  /// Create a copy of UsMarketCalendarResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UsMarketCalendarResponseCopyWith<UsMarketCalendarResponse> get copyWith =>
      _$UsMarketCalendarResponseCopyWithImpl<UsMarketCalendarResponse>(
          this as UsMarketCalendarResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is UsMarketCalendarResponse &&
        (identical(other.nextBusinessDay, _this.nextBusinessDay) ||
            other.nextBusinessDay == _this.nextBusinessDay) &&
        (identical(other.previousBusinessDay, _this.previousBusinessDay) ||
            other.previousBusinessDay == _this.previousBusinessDay) &&
  ...
  String toString() {
    final _this = this as UsMarketCalendarResponse;
    return 'UsMarketCalendarResponse(nextBusinessDay: ${_this
        .nextBusinessDay}, previousBusinessDay: ${_this
        .previousBusinessDay}, today: ${_this.today})';
  }
...
abstract mixin class $UsMarketCalendarResponseCopyWith<$Res> {
  factory $UsMarketCalendarResponseCopyWith(UsMarketCalendarResponse value,
      $Res Function(UsMarketCalendarResponse) _then) = _$UsMarketCalendarResponseCopyWithImpl;
...
extension UsMarketCalendarResponsePatterns on UsMarketCalendarResponse {
  ...
  TResult Function( _UsMarketCalendarResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsMarketCalendarResponse implements UsMarketCalendarResponse {
  const _UsMarketCalendarResponse(
      {required this.nextBusinessDay, required this.previousBusinessDay, required this.today});

  factory _UsMarketCalendarResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsMarketCalendarResponseCopyWith<_UsMarketCalendarResponse> get copyWith =>
      __$UsMarketCalendarResponseCopyWithImpl<_UsMarketCalendarResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is _UsMarketCalendarResponse &&
        (identical(other.nextBusinessDay, nextBusinessDay) ||
            other.nextBusinessDay == nextBusinessDay) &&
        (identical(other.previousBusinessDay, previousBusinessDay) ||
            other.previousBusinessDay == previousBusinessDay) &&
...
/// @nodoc
abstract mixin class _$UsMarketCalendarResponseCopyWith<$Res>
    implements $UsMarketCalendarResponseCopyWith<$Res> {
  factory _$UsMarketCalendarResponseCopyWith(_UsMarketCalendarResponse value,
      $Res Function(_UsMarketCalendarResponse) _then) = __$UsMarketCalendarResponseCopyWithImpl;
  ...
  @override $UsMarketDayCopyWith<$Res> get nextBusinessDay;

  @override $UsMarketDayCopyWith<$Res> get previousBusinessDay;

  @override $UsMarketDayCopyWith<$Res> get today;
...
mixin _$UsMarketDay {
  ...
  UsAfterMarketSession? get afterMarket;

  UsDayMarketSession? get dayMarket;

  UsPreMarketSession? get preMarket;

  UsRegularMarketSession? get regularMarket;

  /// Create a copy of UsMarketDay
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UsMarketDayCopyWith<UsMarketDay> get copyWith =>
      _$UsMarketDayCopyWithImpl<UsMarketDay>(this as UsMarketDay, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsMarketDay &&
            (identical(other.date, _this.date) || other.date == _this.date) &&
            (identical(other.afterMarket, _this.afterMarket) ||
                other.afterMarket == _this.afterMarket) &&
            (identical(other.dayMarket, _this.dayMarket) ||
                other.dayMarket == _this.dayMarket) &&
            (identical(other.preMarket, _this.preMarket) ||
                other.preMarket == _this.preMarket) &&
            (identical(other.regularMarket, _this.regularMarket) ||
                other.regularMarket == _this.regularMarket));
  ...
  int get hashCode {
    final _this = this as UsMarketDay;
    return Object.hash(
        runtimeType, _this.date, _this.afterMarket, _this.dayMarket,
        _this.preMarket, _this.regularMarket);
  }

  @override
  String toString() {
    final _this = this as UsMarketDay;
    return 'UsMarketDay(date: ${_this.date}, afterMarket: ${_this
        .afterMarket}, dayMarket: ${_this.dayMarket}, preMarket: ${_this
        .preMarket}, regularMarket: ${_this.regularMarket})';
  }
...
abstract mixin class $UsMarketDayCopyWith<$Res> {
  factory $UsMarketDayCopyWith(UsMarketDay value,
      $Res Function(UsMarketDay) _then) = _$UsMarketDayCopyWithImpl;
...
class _$UsMarketDayCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? date = null, Object? afterMarket = freezed, Object? dayMarket = freezed, Object? preMarket = freezed, Object? regularMarket = freezed,}) {
    return _then(UsMarketDay(
      ...
      afterMarket: freezed == afterMarket
          ? _self.afterMarket
          : afterMarket // ignore: cast_nullable_to_non_nullable
      as UsAfterMarketSession?,
      dayMarket: freezed == dayMarket
          ? _self.dayMarket
          : dayMarket // ignore: cast_nullable_to_non_nullable
      as UsDayMarketSession?,
      preMarket: freezed == preMarket
          ? _self.preMarket
          : preMarket // ignore: cast_nullable_to_non_nullable
      as UsPreMarketSession?,
      regularMarket: freezed == regularMarket
          ? _self.regularMarket
          : regularMarket // ignore: cast_nullable_to_non_nullable
...
extension UsMarketDayPatterns on UsMarketDay {
  ...
  TResult Function( _UsMarketDay value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsMarketDay implements UsMarketDay {
  const _UsMarketDay(
      {@DateTimeConverter() required this.date, this.afterMarket, this.dayMarket, this.preMarket, this.regularMarket});

  factory _UsMarketDay.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsMarketDayCopyWith<_UsMarketDay> get copyWith =>
      __$UsMarketDayCopyWithImpl<_UsMarketDay>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UsMarketDay &&
            (identical(other.date, date) || other.date == date) &&
            (identical(other.afterMarket, afterMarket) ||
                other.afterMarket == afterMarket) &&
            (identical(other.dayMarket, dayMarket) ||
                other.dayMarket == dayMarket) &&
            (identical(other.preMarket, preMarket) ||
                other.preMarket == preMarket) &&
            (identical(other.regularMarket, regularMarket) ||
                other.regularMarket == regularMarket));
  ...
  int get hashCode {
    return Object.hash(
        runtimeType, date, afterMarket, dayMarket, preMarket, regularMarket);
  }
...
/// @nodoc
abstract mixin class _$UsMarketDayCopyWith<$Res>
    implements $UsMarketDayCopyWith<$Res> {
  factory _$UsMarketDayCopyWith(_UsMarketDay value,
      $Res Function(_UsMarketDay) _then) = __$UsMarketDayCopyWithImpl;
  ...
  @override $UsAfterMarketSessionCopyWith<$Res>? get afterMarket;

  @override $UsDayMarketSessionCopyWith<$Res>? get dayMarket;

  @override $UsPreMarketSessionCopyWith<$Res>? get preMarket;

  @override $UsRegularMarketSessionCopyWith<$Res>? get regularMarket;
...
mixin _$UsAfterMarketSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UsAfterMarketSessionCopyWith<UsAfterMarketSession> get copyWith =>
      _$UsAfterMarketSessionCopyWithImpl<UsAfterMarketSession>(
          this as UsAfterMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsAfterMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime));
  }
  ...
  String toString() {
    final _this = this as UsAfterMarketSession;
    return 'UsAfterMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime})';
  }
...
abstract mixin class $UsAfterMarketSessionCopyWith<$Res> {
  factory $UsAfterMarketSessionCopyWith(UsAfterMarketSession value,
      $Res Function(UsAfterMarketSession) _then) = _$UsAfterMarketSessionCopyWithImpl;
...
class _$UsAfterMarketSessionCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? endTime = null, Object? startTime = null,}) {
...
extension UsAfterMarketSessionPatterns on UsAfterMarketSession {
  ...
  TResult Function( _UsAfterMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsAfterMarketSession implements UsAfterMarketSession {
  const _UsAfterMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime});

  factory _UsAfterMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsAfterMarketSessionCopyWith<_UsAfterMarketSession> get copyWith =>
      __$UsAfterMarketSessionCopyWithImpl<_UsAfterMarketSession>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UsAfterMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
...
/// @nodoc
abstract mixin class _$UsAfterMarketSessionCopyWith<$Res>
    implements $UsAfterMarketSessionCopyWith<$Res> {
  factory _$UsAfterMarketSessionCopyWith(_UsAfterMarketSession value,
      $Res Function(_UsAfterMarketSession) _then) = __$UsAfterMarketSessionCopyWithImpl;
...
mixin _$UsDayMarketSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UsDayMarketSessionCopyWith<UsDayMarketSession> get copyWith =>
      _$UsDayMarketSessionCopyWithImpl<UsDayMarketSession>(
          this as UsDayMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsDayMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime));
  ...
  String toString() {
    final _this = this as UsDayMarketSession;
    return 'UsDayMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime})';
  }
...
abstract mixin class $UsDayMarketSessionCopyWith<$Res> {
  factory $UsDayMarketSessionCopyWith(UsDayMarketSession value,
      $Res Function(UsDayMarketSession) _then) = _$UsDayMarketSessionCopyWithImpl;
...
extension UsDayMarketSessionPatterns on UsDayMarketSession {
  ...
  TResult Function( _UsDayMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsDayMarketSession implements UsDayMarketSession {
  const _UsDayMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime});

  factory _UsDayMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsDayMarketSessionCopyWith<_UsDayMarketSession> get copyWith =>
      __$UsDayMarketSessionCopyWithImpl<_UsDayMarketSession>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UsDayMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
                other.startTime == startTime));
  }
...
/// @nodoc
abstract mixin class _$UsDayMarketSessionCopyWith<$Res>
    implements $UsDayMarketSessionCopyWith<$Res> {
  factory _$UsDayMarketSessionCopyWith(_UsDayMarketSession value,
      $Res Function(_UsDayMarketSession) _then) = __$UsDayMarketSessionCopyWithImpl;
...
mixin _$UsPreMarketSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UsPreMarketSessionCopyWith<UsPreMarketSession> get copyWith =>
      _$UsPreMarketSessionCopyWithImpl<UsPreMarketSession>(
          this as UsPreMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsPreMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime));
  ...
  String toString() {
    final _this = this as UsPreMarketSession;
    return 'UsPreMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime})';
  }
...
abstract mixin class $UsPreMarketSessionCopyWith<$Res> {
  factory $UsPreMarketSessionCopyWith(UsPreMarketSession value,
      $Res Function(UsPreMarketSession) _then) = _$UsPreMarketSessionCopyWithImpl;
...
extension UsPreMarketSessionPatterns on UsPreMarketSession {
  ...
  TResult Function( _UsPreMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsPreMarketSession implements UsPreMarketSession {
  const _UsPreMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime});

  factory _UsPreMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsPreMarketSessionCopyWith<_UsPreMarketSession> get copyWith =>
      __$UsPreMarketSessionCopyWithImpl<_UsPreMarketSession>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UsPreMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
                other.startTime == startTime));
  }
...
/// @nodoc
abstract mixin class _$UsPreMarketSessionCopyWith<$Res>
    implements $UsPreMarketSessionCopyWith<$Res> {
  factory _$UsPreMarketSessionCopyWith(_UsPreMarketSession value,
      $Res Function(_UsPreMarketSession) _then) = __$UsPreMarketSessionCopyWithImpl;
...
mixin _$UsRegularMarketSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UsRegularMarketSessionCopyWith<UsRegularMarketSession> get copyWith =>
      _$UsRegularMarketSessionCopyWithImpl<UsRegularMarketSession>(
          this as UsRegularMarketSession, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsRegularMarketSession &&
            (identical(other.endTime, _this.endTime) ||
                other.endTime == _this.endTime) &&
            (identical(other.startTime, _this.startTime) ||
                other.startTime == _this.startTime));
  ...
  String toString() {
    final _this = this as UsRegularMarketSession;
    return 'UsRegularMarketSession(endTime: ${_this.endTime}, startTime: ${_this
        .startTime})';
  }
...
abstract mixin class $UsRegularMarketSessionCopyWith<$Res> {
  factory $UsRegularMarketSessionCopyWith(UsRegularMarketSession value,
      $Res Function(UsRegularMarketSession) _then) = _$UsRegularMarketSessionCopyWithImpl;
...
extension UsRegularMarketSessionPatterns on UsRegularMarketSession {
  ...
  TResult Function( _UsRegularMarketSession value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsRegularMarketSession implements UsRegularMarketSession {
  const _UsRegularMarketSession(
      {@DateTimeConverter() required this.endTime, @DateTimeConverter() required this.startTime});

  factory _UsRegularMarketSession.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsRegularMarketSessionCopyWith<_UsRegularMarketSession> get copyWith =>
      __$UsRegularMarketSessionCopyWithImpl<_UsRegularMarketSession>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UsRegularMarketSession &&
            (identical(other.endTime, endTime) || other.endTime == endTime) &&
            (identical(other.startTime, startTime) ||
                other.startTime == startTime));
  }
...
/// @nodoc
abstract mixin class _$UsRegularMarketSessionCopyWith<$Res>
    implements $UsRegularMarketSessionCopyWith<$Res> {
  factory _$UsRegularMarketSessionCopyWith(_UsRegularMarketSession value,
      $Res Function(_UsRegularMarketSession) _then) = __$UsRegularMarketSessionCopyWithImpl;
