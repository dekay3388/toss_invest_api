...
mixin _$OAuth2TokenResponse {
  ...
  @JsonKey(name: "token_type") String get tokenType;

  /// Create a copy of OAuth2TokenResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $OAuth2TokenResponseCopyWith<OAuth2TokenResponse> get copyWith =>
      _$OAuth2TokenResponseCopyWithImpl<OAuth2TokenResponse>(
          this as OAuth2TokenResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is OAuth2TokenResponse &&
            (identical(other.accessToken, _this.accessToken) ||
                other.accessToken == _this.accessToken) &&
            (identical(other.expiresIn, _this.expiresIn) ||
                other.expiresIn == _this.expiresIn) &&
            (identical(other.tokenType, _this.tokenType) ||
  ...
  int get hashCode {
    final _this = this as OAuth2TokenResponse;
    return Object.hash(
        runtimeType, _this.accessToken, _this.expiresIn, _this.tokenType);
  }

  @override
  String toString() {
    final _this = this as OAuth2TokenResponse;
    return 'OAuth2TokenResponse(accessToken: ${_this
        .accessToken}, expiresIn: ${_this.expiresIn}, tokenType: ${_this
        .tokenType})';
  }
...
abstract mixin class $OAuth2TokenResponseCopyWith<$Res> {
  factory $OAuth2TokenResponseCopyWith(OAuth2TokenResponse value,
      $Res Function(OAuth2TokenResponse) _then) = _$OAuth2TokenResponseCopyWithImpl;

  @useResult
  $Res call({
    @JsonKey(name: "access_token") String accessToken, @JsonKey(
        name: "expires_in") int expiresIn, @JsonKey(
...
class _$OAuth2TokenResponseCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? accessToken = null, Object? expiresIn = null, Object? tokenType = null,}) {
...
extension OAuth2TokenResponsePatterns on OAuth2TokenResponse {
  ...
  TResult Function( _OAuth2TokenResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _OAuth2TokenResponse implements OAuth2TokenResponse {
  const _OAuth2TokenResponse(
      {@JsonKey(name: "access_token") required this.accessToken, @JsonKey(
          name: "expires_in") required this.expiresIn, @JsonKey(
          name: "token_type") required this.tokenType});

  factory _OAuth2TokenResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$OAuth2TokenResponseCopyWith<_OAuth2TokenResponse> get copyWith =>
      __$OAuth2TokenResponseCopyWithImpl<_OAuth2TokenResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _OAuth2TokenResponse &&
...
/// @nodoc
abstract mixin class _$OAuth2TokenResponseCopyWith<$Res>
    implements $OAuth2TokenResponseCopyWith<$Res> {
  factory _$OAuth2TokenResponseCopyWith(_OAuth2TokenResponse value,
      $Res Function(_OAuth2TokenResponse) _then) = __$OAuth2TokenResponseCopyWithImpl;
