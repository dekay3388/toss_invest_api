...
mixin _$PaginatedOrderResponse {
  ...
  $PaginatedOrderResponseCopyWith<PaginatedOrderResponse> get copyWith =>
      _$PaginatedOrderResponseCopyWithImpl<PaginatedOrderResponse>(
          this as PaginatedOrderResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PaginatedOrderResponse &&
            (identical(other.hasNext, _this.hasNext) ||
                other.hasNext == _this.hasNext) &&
            (identical(other.nextCursor, _this.nextCursor) ||
                other.nextCursor == _this.nextCursor) &&
            const DeepCollectionEquality().equals(other.orders, _this.orders));
  }
  ...
  int get hashCode {
    final _this = this as PaginatedOrderResponse;
    return Object.hash(runtimeType, _this.hasNext, _this.nextCursor,
        const DeepCollectionEquality().hash(_this.orders));
  }

  @override
  String toString() {
    final _this = this as PaginatedOrderResponse;
    return 'PaginatedOrderResponse(hasNext: ${_this
        .hasNext}, nextCursor: ${_this.nextCursor}, orders: ${_this.orders})';
  }
...
abstract mixin class $PaginatedOrderResponseCopyWith<$Res> {
  factory $PaginatedOrderResponseCopyWith(PaginatedOrderResponse value,
      $Res Function(PaginatedOrderResponse) _then) = _$PaginatedOrderResponseCopyWithImpl;
...
class _$PaginatedOrderResponseCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? hasNext = null, Object? nextCursor = freezed, Object? orders = null,}) {
...
extension PaginatedOrderResponsePatterns on PaginatedOrderResponse {
  ...
  TResult Function( _PaginatedOrderResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _PaginatedOrderResponse implements PaginatedOrderResponse {
  const _PaginatedOrderResponse(
      {required this.hasNext, required this.nextCursor, required List<
          Order> orders}) : _orders = orders;

  factory _PaginatedOrderResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PaginatedOrderResponseCopyWith<_PaginatedOrderResponse> get copyWith =>
      __$PaginatedOrderResponseCopyWithImpl<_PaginatedOrderResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _PaginatedOrderResponse &&
            (identical(other.hasNext, hasNext) || other.hasNext == hasNext) &&
            (identical(other.nextCursor, nextCursor) ||
                other.nextCursor == nextCursor) &&
            const DeepCollectionEquality().equals(other.orders, _orders));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode {
    return Object.hash(runtimeType, hasNext, nextCursor,
...
/// @nodoc
abstract mixin class _$PaginatedOrderResponseCopyWith<$Res>
    implements $PaginatedOrderResponseCopyWith<$Res> {
  factory _$PaginatedOrderResponseCopyWith(_PaginatedOrderResponse value,
      $Res Function(_PaginatedOrderResponse) _then) = __$PaginatedOrderResponseCopyWithImpl;
...
mixin _$Order {
  ...
  OrderExecution get execution;

  @DateTimeConverter() DateTime get orderedAt;
  ...
  @DateTimeConverter() DateTime? get canceledAt;
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Order &&
            (identical(other.currency, _this.currency) ||
                other.currency == _this.currency) &&
            (identical(other.execution, _this.execution) ||
                other.execution == _this.execution) &&
            (identical(other.orderedAt, _this.orderedAt) ||
                other.orderedAt == _this.orderedAt) &&
            (identical(other.orderId, _this.orderId) ||
                other.orderId == _this.orderId) &&
            (identical(other.orderType, _this.orderType) ||
                other.orderType == _this.orderType) &&
            (identical(other.quantity, _this.quantity) ||
                other.quantity == _this.quantity) &&
            (identical(other.side, _this.side) || other.side == _this.side) &&
            (identical(other.status, _this.status) ||
                other.status == _this.status) &&
            (identical(other.symbol, _this.symbol) ||
                other.symbol == _this.symbol) &&
            (identical(other.timeInForce, _this.timeInForce) ||
                other.timeInForce == _this.timeInForce) &&
            (identical(other.canceledAt, _this.canceledAt) ||
                other.canceledAt == _this.canceledAt) &&
            (identical(other.orderAmount, _this.orderAmount) ||
                other.orderAmount == _this.orderAmount) &&
  ...
  String toString() {
    final _this = this as Order;
    return 'Order(currency: ${_this.currency}, execution: ${_this
        .execution}, orderedAt: ${_this.orderedAt}, orderId: ${_this
        .orderId}, orderType: ${_this.orderType}, quantity: ${_this
        .quantity}, side: ${_this.side}, status: ${_this
        .status}, symbol: ${_this.symbol}, timeInForce: ${_this
        .timeInForce}, canceledAt: ${_this.canceledAt}, orderAmount: ${_this
        .orderAmount}, price: ${_this.price})';
  }
...
abstract mixin class $OrderCopyWith<$Res> {
  factory $OrderCopyWith(Order value,
      $Res Function(Order) _then) = _$OrderCopyWithImpl;
...
class _$OrderCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? currency = null, Object? execution = null, Object? orderedAt = null, Object? orderId = null, Object? orderType = null, Object? quantity = null, Object? side = null, Object? status = null, Object? symbol = null, Object? timeInForce = null, Object? canceledAt = freezed, Object? orderAmount = freezed, Object? price = freezed,}) {
    return _then(Order(
...
extension OrderPatterns on Order {
  ...
  TResult Function( _Order value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _Order implements Order {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Order &&
...
abstract mixin class _$OrderCopyWith<$Res> implements $OrderCopyWith<$Res> {
  factory _$OrderCopyWith(_Order value,
      $Res Function(_Order) _then) = __$OrderCopyWithImpl;
...
mixin _$OrderExecution {
  ...
  String? get averageFilledPrice;

  String? get commission;

  String? get filledAmount;

  @DateTimeConverter() DateTime? get filledAt;

  String get filledQuantity;

  @DateTimeConverter() DateTime? get settlementDate;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $OrderExecutionCopyWith<OrderExecution> get copyWith =>
      _$OrderExecutionCopyWithImpl<OrderExecution>(
          this as OrderExecution, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is OrderExecution &&
            (identical(other.averageFilledPrice, _this.averageFilledPrice) ||
                other.averageFilledPrice == _this.averageFilledPrice) &&
            (identical(other.commission, _this.commission) ||
                other.commission == _this.commission) &&
            (identical(other.filledAmount, _this.filledAmount) ||
                other.filledAmount == _this.filledAmount) &&
            (identical(other.filledAt, _this.filledAt) ||
                other.filledAt == _this.filledAt) &&
            (identical(other.filledQuantity, _this.filledQuantity) ||
                other.filledQuantity == _this.filledQuantity) &&
            (identical(other.settlementDate, _this.settlementDate) ||
                other.settlementDate == _this.settlementDate) &&
  ...
  int get hashCode {
    ...
    return Object.hash(
        runtimeType,
        _this.averageFilledPrice,
        _this.commission,
        _this.filledAmount,
        _this.filledAt,
        _this.filledQuantity,
        _this.settlementDate,
        _this.tax);
  }
  ...
  String toString() {
    final _this = this as OrderExecution;
    return 'OrderExecution(averageFilledPrice: ${_this
        .averageFilledPrice}, commission: ${_this
        .commission}, filledAmount: ${_this.filledAmount}, filledAt: ${_this
        .filledAt}, filledQuantity: ${_this
        .filledQuantity}, settlementDate: ${_this.settlementDate}, tax: ${_this
        .tax})';
  }
...
abstract mixin class $OrderExecutionCopyWith<$Res> {
  factory $OrderExecutionCopyWith(OrderExecution value,
      $Res Function(OrderExecution) _then) = _$OrderExecutionCopyWithImpl;
...
class _$OrderExecutionCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? averageFilledPrice = freezed, Object? commission = freezed, Object? filledAmount = freezed, Object? filledAt = freezed, Object? filledQuantity = null, Object? settlementDate = freezed, Object? tax = freezed,}) {
    return _then(OrderExecution(
      averageFilledPrice: freezed == averageFilledPrice
          ? _self.averageFilledPrice
          : averageFilledPrice // ignore: cast_nullable_to_non_nullable
      as String?,
      commission: freezed == commission
          ? _self.commission
          : commission // ignore: cast_nullable_to_non_nullable
      as String?,
      filledAmount: freezed == filledAmount
          ? _self.filledAmount
          : filledAmount // ignore: cast_nullable_to_non_nullable
      as String?,
      filledAt: freezed == filledAt
          ? _self.filledAt
          : filledAt // ignore: cast_nullable_to_non_nullable
      as DateTime?,
      filledQuantity: null == filledQuantity
          ? _self.filledQuantity
          : filledQuantity // ignore: cast_nullable_to_non_nullable
      as String,
      settlementDate: freezed == settlementDate
          ? _self.settlementDate
...
extension OrderExecutionPatterns on OrderExecution {
  ...
  TResult Function( _OrderExecution value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _OrderExecution implements OrderExecution {
  const _OrderExecution(
      {required this.averageFilledPrice, required this.commission, required this.filledAmount, @DateTimeConverter() required this.filledAt, required this.filledQuantity, @DateTimeConverter() required this.settlementDate, required this.tax});

  factory _OrderExecution.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$OrderExecutionCopyWith<_OrderExecution> get copyWith =>
      __$OrderExecutionCopyWithImpl<_OrderExecution>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _OrderExecution &&
            (identical(other.averageFilledPrice, averageFilledPrice) ||
                other.averageFilledPrice == averageFilledPrice) &&
            (identical(other.commission, commission) ||
                other.commission == commission) &&
            (identical(other.filledAmount, filledAmount) ||
                other.filledAmount == filledAmount) &&
...
/// @nodoc
abstract mixin class _$OrderExecutionCopyWith<$Res>
    implements $OrderExecutionCopyWith<$Res> {
  factory _$OrderExecutionCopyWith(_OrderExecution value,
      $Res Function(_OrderExecution) _then) = __$OrderExecutionCopyWithImpl;
