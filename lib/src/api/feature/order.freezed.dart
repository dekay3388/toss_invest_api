...
mixin _$OrderResponse {
 ...
 String get orderId; String? get clientOrderId;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderResponse&&(identical(other.orderId, _this.orderId) || other.orderId == _this.orderId)&&(identical(other.clientOrderId, _this.clientOrderId) || other.clientOrderId == _this.clientOrderId));
}
...
String toString() {
  final _this = this as OrderResponse;
  return 'OrderResponse(orderId: ${_this.orderId}, clientOrderId: ${_this.clientOrderId})';
}
...
/// Create a copy of OrderResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? orderId = null,Object? clientOrderId = freezed,}) {
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderResponse&&(identical(other.orderId, orderId) || other.orderId == orderId)&&(identical(other.clientOrderId, clientOrderId) || other.clientOrderId == clientOrderId));
}
...
/// Create a copy of OrderResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? orderId = null,Object? clientOrderId = freezed,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$OrderOperationResponseCopyWith<OrderOperationResponse> get copyWith => _$OrderOperationResponseCopyWithImpl<OrderOperationResponse>(this as OrderOperationResponse, _$identity);
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderOperationResponse&&(identical(other.orderId, _this.orderId) || other.orderId == _this.orderId));
}
...
abstract mixin class $OrderOperationResponseCopyWith<$Res>  {
  factory $OrderOperationResponseCopyWith(OrderOperationResponse value, $Res Function(OrderOperationResponse) _then) = _$OrderOperationResponseCopyWithImpl;
@useResult
$Res call({
 String orderId
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OrderOperationResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _OrderOperationResponse implements OrderOperationResponse {
  ...
  factory _OrderOperationResponse.fromJson(Map<String, dynamic> json) => _$OrderOperationResponseFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$OrderOperationResponseCopyWith<_OrderOperationResponse> get copyWith => __$OrderOperationResponseCopyWithImpl<_OrderOperationResponse>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderOperationResponse&&(identical(other.orderId, orderId) || other.orderId == orderId));
}
...
/// @nodoc
abstract mixin class _$OrderOperationResponseCopyWith<$Res> implements $OrderOperationResponseCopyWith<$Res> {
  factory _$OrderOperationResponseCopyWith(_OrderOperationResponse value, $Res Function(_OrderOperationResponse) _then) = __$OrderOperationResponseCopyWithImpl;
@override @useResult
$Res call({
 String orderId
});
