...
mixin _$Account {
  ...
  @StringConverter() String get accountSeq;
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Account &&
            (identical(other.accountNo, _this.accountNo) ||
                other.accountNo == _this.accountNo) &&
            (identical(other.accountSeq, _this.accountSeq) ||
                other.accountSeq == _this.accountSeq) &&
            (identical(other.accountType, _this.accountType) ||
                other.accountType == _this.accountType));
  }
  ...
  int get hashCode {
    final _this = this as Account;
    return Object.hash(
        runtimeType, _this.accountNo, _this.accountSeq, _this.accountType);
  }

  @override
  String toString() {
    final _this = this as Account;
    return 'Account(accountNo: ${_this.accountNo}, accountSeq: ${_this
        .accountSeq}, accountType: ${_this.accountType})';
  }
...
abstract mixin class $AccountCopyWith<$Res> {
  factory $AccountCopyWith(Account value,
      $Res Function(Account) _then) = _$AccountCopyWithImpl;
...
class _$AccountCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? accountNo = null, Object? accountSeq = null, Object? accountType = null,}) {
    return _then(Account(
      accountNo: null == accountNo
          ? _self.accountNo
          : accountNo // ignore: cast_nullable_to_non_nullable
      as String,
      accountSeq: null == accountSeq
          ? _self.accountSeq
          : accountSeq // ignore: cast_nullable_to_non_nullable
      as String,
...
extension AccountPatterns on Account {
  ...
  TResult Function( _Account value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _Account implements Account {
  const _Account(
      {required this.accountNo, @StringConverter() required this.accountSeq, required this.accountType});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Account &&
            (identical(other.accountNo, accountNo) ||
                other.accountNo == accountNo) &&
            (identical(other.accountSeq, accountSeq) ||
...
abstract mixin class _$AccountCopyWith<$Res> implements $AccountCopyWith<$Res> {
  factory _$AccountCopyWith(_Account value,
      $Res Function(_Account) _then) = __$AccountCopyWithImpl;
