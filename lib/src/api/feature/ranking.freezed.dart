...
mixin _$RankingResponse {
 ...
 List<RankingItem> get rankings;@DateTimeConverter() DateTime? get rankedAt;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RankingResponse&&const DeepCollectionEquality().equals(other.rankings, _this.rankings)&&(identical(other.rankedAt, _this.rankedAt) || other.rankedAt == _this.rankedAt));
}
...
int get hashCode {
  final _this = this as RankingResponse;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.rankings),_this.rankedAt);
}

@override
String toString() {
  final _this = this as RankingResponse;
  return 'RankingResponse(rankings: ${_this.rankings}, rankedAt: ${_this.rankedAt})';
}
...
/// Create a copy of RankingResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rankings = null,Object? rankedAt = freezed,}) {
  return _then(RankingResponse(
rankings: null == rankings ? _self.rankings : rankings // ignore: cast_nullable_to_non_nullable
as List<RankingItem>,rankedAt: freezed == rankedAt ? _self.rankedAt : rankedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
class _RankingResponse implements RankingResponse {
  const _RankingResponse({required  List<RankingItem> rankings, @DateTimeConverter() this.rankedAt}): _rankings = rankings;
...
@override@DateTimeConverter() final  DateTime? rankedAt;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _RankingResponse&&const DeepCollectionEquality().equals(other.rankings, _rankings)&&(identical(other.rankedAt, rankedAt) || other.rankedAt == rankedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_rankings),rankedAt);
}
...
/// Create a copy of RankingResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rankings = null,Object? rankedAt = freezed,}) {
...
mixin _$RankingItem {
 ...
 Currency get currency; RankingPrice get price; int get rank; String get symbol; String get tradingAmount; String get tradingVolume;
...
int get hashCode {
  final _this = this as RankingItem;
  return Object.hash(runtimeType,_this.currency,_this.price,_this.rank,_this.symbol,_this.tradingAmount,_this.tradingVolume);
}

@override
String toString() {
  final _this = this as RankingItem;
  return 'RankingItem(currency: ${_this.currency}, price: ${_this.price}, rank: ${_this.rank}, symbol: ${_this.symbol}, tradingAmount: ${_this.tradingAmount}, tradingVolume: ${_this.tradingVolume})';
}
...
/// Create a copy of RankingItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currency = null,Object? price = null,Object? rank = null,Object? symbol = null,Object? tradingAmount = null,Object? tradingVolume = null,}) {
...
as RankingPrice,rank: null == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
as int,symbol: null == symbol ? _self.symbol : symbol // ignore: cast_nullable_to_non_nullable
as String,tradingAmount: null == tradingAmount ? _self.tradingAmount : tradingAmount // ignore: cast_nullable_to_non_nullable
as String,tradingVolume: null == tradingVolume ? _self.tradingVolume : tradingVolume // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of RankingItem
...
class _RankingItem implements RankingItem {
  const _RankingItem({required this.currency, required this.price, required this.rank, required this.symbol, required this.tradingAmount, required this.tradingVolume});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _RankingItem&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.price, price) || other.price == price)&&(identical(other.rank, rank) || other.rank == rank)&&(identical(other.symbol, symbol) || other.symbol == symbol)&&(identical(other.tradingAmount, tradingAmount) || other.tradingAmount == tradingAmount)&&(identical(other.tradingVolume, tradingVolume) || other.tradingVolume == tradingVolume));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,currency,price,rank,symbol,tradingAmount,tradingVolume);
}
...
/// Create a copy of RankingItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currency = null,Object? price = null,Object? rank = null,Object? symbol = null,Object? tradingAmount = null,Object? tradingVolume = null,}) {
...
mixin _$RankingPrice {
 ...
 String get basePrice; String get lastPrice; String? get changeRate;
/// Create a copy of RankingPrice
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RankingPriceCopyWith<RankingPrice> get copyWith => _$RankingPriceCopyWithImpl<RankingPrice>(this as RankingPrice, _$identity);
...
int get hashCode {
  final _this = this as RankingPrice;
  return Object.hash(runtimeType,_this.basePrice,_this.lastPrice,_this.changeRate);
}

@override
String toString() {
  final _this = this as RankingPrice;
  return 'RankingPrice(basePrice: ${_this.basePrice}, lastPrice: ${_this.lastPrice}, changeRate: ${_this.changeRate})';
}
...
abstract mixin class $RankingPriceCopyWith<$Res>  {
  factory $RankingPriceCopyWith(RankingPrice value, $Res Function(RankingPrice) _then) = _$RankingPriceCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of RankingPrice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? basePrice = null,Object? lastPrice = null,Object? changeRate = freezed,}) {
...
as String,changeRate: freezed == changeRate ? _self.changeRate : changeRate // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RankingPrice value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _RankingPrice implements RankingPrice {
  const _RankingPrice({required this.basePrice, required this.lastPrice, this.changeRate});
  factory _RankingPrice.fromJson(Map<String, dynamic> json) => _$RankingPriceFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RankingPriceCopyWith<_RankingPrice> get copyWith => __$RankingPriceCopyWithImpl<_RankingPrice>(this, _$identity);
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _RankingPrice&&(identical(other.basePrice, basePrice) || other.basePrice == basePrice)&&(identical(other.lastPrice, lastPrice) || other.lastPrice == lastPrice)&&(identical(other.changeRate, changeRate) || other.changeRate == changeRate));
}
...
/// @nodoc
abstract mixin class _$RankingPriceCopyWith<$Res> implements $RankingPriceCopyWith<$Res> {
  factory _$RankingPriceCopyWith(_RankingPrice value, $Res Function(_RankingPrice) _then) = __$RankingPriceCopyWithImpl;
@override @useResult
$Res call({
 String basePrice, String lastPrice, String? changeRate
});
...
/// Create a copy of RankingPrice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? basePrice = null,Object? lastPrice = null,Object? changeRate = freezed,}) {
