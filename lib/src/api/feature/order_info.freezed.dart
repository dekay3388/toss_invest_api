...
mixin _$BuyingPowerResponse {
  ...
  $BuyingPowerResponseCopyWith<BuyingPowerResponse> get copyWith =>
      _$BuyingPowerResponseCopyWithImpl<BuyingPowerResponse>(
          this as BuyingPowerResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BuyingPowerResponse &&
            (identical(other.cashBuyingPower, _this.cashBuyingPower) ||
                other.cashBuyingPower == _this.cashBuyingPower) &&
  ...
  String toString() {
    final _this = this as BuyingPowerResponse;
    return 'BuyingPowerResponse(cashBuyingPower: ${_this
        .cashBuyingPower}, currency: ${_this.currency})';
  }
...
abstract mixin class $BuyingPowerResponseCopyWith<$Res> {
  factory $BuyingPowerResponseCopyWith(BuyingPowerResponse value,
      $Res Function(BuyingPowerResponse) _then) = _$BuyingPowerResponseCopyWithImpl;
...
class _$BuyingPowerResponseCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? cashBuyingPower = null, Object? currency = null,}) {
    return _then(BuyingPowerResponse(
      cashBuyingPower: null == cashBuyingPower
          ? _self.cashBuyingPower
          : cashBuyingPower // ignore: cast_nullable_to_non_nullable
      as String,
...
extension BuyingPowerResponsePatterns on BuyingPowerResponse {
  ...
  TResult Function( _BuyingPowerResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _BuyingPowerResponse implements BuyingPowerResponse {
  const _BuyingPowerResponse(
      {required this.cashBuyingPower, required this.currency});

  factory _BuyingPowerResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BuyingPowerResponseCopyWith<_BuyingPowerResponse> get copyWith =>
      __$BuyingPowerResponseCopyWithImpl<_BuyingPowerResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _BuyingPowerResponse &&
            (identical(other.cashBuyingPower, cashBuyingPower) ||
                other.cashBuyingPower == cashBuyingPower) &&
...
/// @nodoc
abstract mixin class _$BuyingPowerResponseCopyWith<$Res>
    implements $BuyingPowerResponseCopyWith<$Res> {
  factory _$BuyingPowerResponseCopyWith(_BuyingPowerResponse value,
      $Res Function(_BuyingPowerResponse) _then) = __$BuyingPowerResponseCopyWithImpl;
...
mixin _$SellableQuantityResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SellableQuantityResponseCopyWith<SellableQuantityResponse> get copyWith =>
      _$SellableQuantityResponseCopyWithImpl<SellableQuantityResponse>(
          this as SellableQuantityResponse, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is SellableQuantityResponse &&
        (identical(other.sellableQuantity, _this.sellableQuantity) ||
            other.sellableQuantity == _this.sellableQuantity));
  }
  ...
  String toString() {
    final _this = this as SellableQuantityResponse;
    return 'SellableQuantityResponse(sellableQuantity: ${_this
        .sellableQuantity})';
  }
...
abstract mixin class $SellableQuantityResponseCopyWith<$Res> {
  factory $SellableQuantityResponseCopyWith(SellableQuantityResponse value,
      $Res Function(SellableQuantityResponse) _then) = _$SellableQuantityResponseCopyWithImpl;
...
class _$SellableQuantityResponseCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? sellableQuantity = null,}) {
    return _then(SellableQuantityResponse(
      sellableQuantity: null == sellableQuantity
          ? _self.sellableQuantity
          : sellableQuantity // ignore: cast_nullable_to_non_nullable
      as String,
    ));
  }
...
extension SellableQuantityResponsePatterns on SellableQuantityResponse {
  ...
  TResult Function( _SellableQuantityResponse value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _SellableQuantityResponse implements SellableQuantityResponse {
  ...
  factory _SellableQuantityResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SellableQuantityResponseCopyWith<_SellableQuantityResponse> get copyWith =>
      __$SellableQuantityResponseCopyWithImpl<_SellableQuantityResponse>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is _SellableQuantityResponse &&
        (identical(other.sellableQuantity, sellableQuantity) ||
            other.sellableQuantity == sellableQuantity));
  }
...
/// @nodoc
abstract mixin class _$SellableQuantityResponseCopyWith<$Res>
    implements $SellableQuantityResponseCopyWith<$Res> {
  factory _$SellableQuantityResponseCopyWith(_SellableQuantityResponse value,
      $Res Function(_SellableQuantityResponse) _then) = __$SellableQuantityResponseCopyWithImpl;
...
mixin _$Commission {
  ...
  $CommissionCopyWith<Commission> get copyWith =>
      _$CommissionCopyWithImpl<Commission>(this as Commission, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Commission &&
            (identical(other.commissionRate, _this.commissionRate) ||
  ...
  int get hashCode {
    final _this = this as Commission;
    return Object.hash(
        runtimeType, _this.commissionRate, _this.marketCountry, _this.endDate,
        _this.startDate);
  }
  ...
  String toString() {
    final _this = this as Commission;
    return 'Commission(commissionRate: ${_this
        .commissionRate}, marketCountry: ${_this
        .marketCountry}, endDate: ${_this.endDate}, startDate: ${_this
        .startDate})';
  }
...
abstract mixin class $CommissionCopyWith<$Res> {
  factory $CommissionCopyWith(Commission value,
      $Res Function(Commission) _then) = _$CommissionCopyWithImpl;
...
class _$CommissionCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? commissionRate = null, Object? marketCountry = null, Object? endDate = freezed, Object? startDate = freezed,}) {
...
extension CommissionPatterns on Commission {
  ...
  TResult Function( _Commission value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _Commission implements Commission {
  const _Commission(
      {required this.commissionRate, required this.marketCountry, @DateTimeConverter() this.endDate, @DateTimeConverter() this.startDate});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CommissionCopyWith<_Commission> get copyWith =>
      __$CommissionCopyWithImpl<_Commission>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Commission &&
  ...
  int get hashCode {
    return Object.hash(
        runtimeType, commissionRate, marketCountry, endDate, startDate);
  }
...
/// @nodoc
abstract mixin class _$CommissionCopyWith<$Res>
    implements $CommissionCopyWith<$Res> {
  factory _$CommissionCopyWith(_Commission value,
      $Res Function(_Commission) _then) = __$CommissionCopyWithImpl;
